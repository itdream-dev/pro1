...
@section('content')
    ...
    <div class="content row" style="padding:20px;overflow-y: scroll;height:750px">
      ...
      <div class="row" style="border-bottom:1px solid #ddd;padding-top:20px">
        <div class="col-sm-10">
          <h3>2-step Verification <span class="verified disabled">Disabled</span></h3>
          <p>Protect your wallet from unauthorized access by enabling 2-Step Verification. You can choose to use a free app or your mobile phone number to secure your wallet.</p>
        </div>
        <div class="col-sm-2" style="text-align:right">
