    ...
    <div class="container" style="background: #368e64;width:100%">
      <div class="row v-center"  style="margin-top:150px;">
        <div class="col-xs-12 col-md-12" style="text-align:center;font-size:35px;margin-top:80px;">
          The safer CampusCoin wallet that puts you in control
        </div>
        <div class="col-xs-12 col-md-12" style="text-align:center;margin-top:70px;color:#000">
          <button class="btn btn-lg" onclick="location.href='/home'" style="background:#ffffff;padding:10px 26px;width:300px;font-weight:bold;color:#368e64">Get Wallet!</button>
        </div>
        <!-- <div class="col-xs-12 col-md-12" style="text-align:center;font-size:35px;padding-top:100px">
            <div class="col-xs-3 col-md-3"></div>
            <div class="col-xs-6 col-md-6">
              <div class="row">
                <div class="col-sm-6" style="margin-top:50px;">
                  <img src="/img/icon-big-lock.png" alt="Improved security"/>
                  <h3 style="margin-top:15px;">Secure security</h3>
                </div>
                <div class="col-sm-6" style="margin-top:50px;">
                  <img src="/img/icon-big-login.png" alt="Quick login"/>
                  <h3 style="margin-top:15px;">Quick Handling</h3>
                </div>
              </div>
            </div>
        </div> -->
